...
| 2 — Auto-registration | 🚧 In progress | — | Folds the factory's descriptor into `template-registry.tsx` + `export-params.ts` + `migrated-templates.ts` + `StageBenchEditor.tsx`. Start with the 3 pilots, then propagate. |
