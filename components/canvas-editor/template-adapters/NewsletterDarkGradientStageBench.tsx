 ...
 *
 * Structural twin of NewsletterBlueGradient / NewsletterLight — same slots,
...
export const NewsletterDarkGradientStageBench = defineStageBenchAdapter<NewsletterDarkGradientBlockId>({
  ...
  contentStack: { templateKey: 'newsletter-dark-gradient', maxGap: 48 },
  useStoreBindings: () => {
    ...
    const gaps = useStore((s) => s.templateGaps['newsletter-dark-gradient'] ?? {})
    ...
    return {
      ...
      contentStack: {
        ...
        setStackAlign,
        gaps,
        setGap: (key, value) => setTemplateGap('newsletter-dark-gradient', key, value),
      },
