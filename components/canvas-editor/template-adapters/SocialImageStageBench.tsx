...
/**
 * Stage & Bench adapter for social-image (factory-driven).
 *
...
export const SocialImageStageBench = defineStageBenchAdapter<SocialImageBlockId>({
  ...
  contentStack: { templateKey: 'social-image' },
  useStoreBindings: () => {
    ...
    const gaps = useStore((s) => s.templateGaps['social-image'] ?? {})
    ...
    const raw = thumbnailImageSettings['social-image']
    ...
    return {
      ...
      image: {
        ...
        setSettings: (next) => setThumbnailImageSettings('social-image', next),
        frameWidth,
        frameHeight: 628,
      },
      category: {
      ...
      contentStack: {
        ...
        setStackAlign,
        gaps,
        setGap: (key, value) => setTemplateGap('social-image', key, value),
      },
