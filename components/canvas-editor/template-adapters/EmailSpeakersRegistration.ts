...
export const emailSpeakersRegistration: StageBenchRegistrationData = {
  ...
  renderProps: (asset, colors, typography) => ({
    ...
    showSpeaker2: asset.showSpeaker2 !== false,
    showSpeaker3: asset.showSpeaker3 !== false,
  ...
  renderSchema: {
    ...
    fields: [
      ...
      { param: 'showSpeaker1', parser: 'boolTrue', default: true },
      { param: 'showSpeaker2', parser: 'boolTrue', default: true },
      { param: 'showSpeaker3', parser: 'boolTrue', default: true },
