...
/**
 * Stage & Bench adapter for website-thumbnail (factory-driven).
 *
 * Track 2. Ebook card. Editable: eyebrow / headline / subhead / cta +
...
export const WebsiteThumbnailStageBench =
  defineStageBenchAdapter<WebsiteThumbnailBlockId>({
    ...
    contentStack: { templateKey: 'website-thumbnail', maxGap: 96 },
    useStoreBindings: () => {
      ...
      const gaps = useStore((s) => s.templateGaps['website-thumbnail'] ?? {})
      ...
      return {
        ...
        image: {
          ...
          setSettings: (next) => setThumbnailImageSettings('website-thumbnail', next),
          frameWidth: 320,
          frameHeight: 386,
        },
        category: {
        ...
        contentStack: {
          ...
          setStackAlign,
          gaps,
          setGap: (key, value) => setTemplateGap('website-thumbnail', key, value),
        },
        extras: { theme, ebookVariant: ebookVariant as EbookVariant, grayscale, solution },
      }
    },
    renderTemplate: (ctx) => {
      const theme = ctx.extras.theme as TemplateTheme
      const variant = ctx.extras.ebookVariant as EbookVariant
