/**
 * Shared Cority logo SVG component.
 * Used across all template components for export-compatible inline rendering.
 */
export const CorityLogo = ({ fill = '#000000', height = 23 }: { fill?: string; height?: number }) => {
  const width = Math.round(height * (383.8 / 128.41))
  return (
    <svg
