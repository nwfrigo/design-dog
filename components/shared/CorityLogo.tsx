...
/**
 * Cority logo SVG component.
 * Inline SVG ensures export compatibility with Puppeteer screenshots.
 */
export function CorityLogo({ fill = '#000000', height = 28 }: CorityLogoProps) {
  // Original viewBox aspect ratio: 383.8 / 128.41 ≈ 2.988
