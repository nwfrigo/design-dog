...
const CorityLogo = ({ fill = '#FFFFFF', height = 23 }: { fill?: string; height?: number }) => {
  const width = Math.round(height * 3.063)
  return (
    <svg
...
const ArrowIcon = ({ color = 'white', size = 16.5 }: { color?: string; size?: number }) => (
  <svg width={size} height={size * 0.795} viewBox="0 0 16.5 13.12" fill="none">
    <path
      d="M9.75 0.75L15.75 6.56M15.75 6.56L9.75 12.37M15.75 6.56H0.75"
      stroke={color}
      strokeWidth={1.12}
      strokeLinecap="round"
          ...
          <div style={{
            ...
            {ctaStyle === 'link' ? (
              ...
              >
                ...
                <ArrowIcon color={ctaColor} size={16.5} />
              </div>
            ) : (
              <div
                style={{
