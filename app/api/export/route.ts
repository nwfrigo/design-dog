...
const TEMPLATE_DIMENSIONS: Record<string, { width: number; height: number }> = {
  ...
  'website-ehs-accelerate-listing': { width: 800, height: 450 },
  ...
  'email-ehs-accelerate-banner': { width: 600, height: 373 },
  'email-ehs-accelerate-invitation': { width: 420, height: 595 },
  'email-ehs-accelerate-signature': { width: 400, height: 100 },
  'email-cority-customer-exchange-signature': { width: 400, height: 100 },
  'email-cority-customer-exchange-banner': { width: 640, height: 300 },
  ...
  'social-ehs-accelerate': { width: 1200, height: 628 },
