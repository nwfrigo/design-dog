...
function HomeContent() {
  ...
  useEffect(() => {
    if (currentScreen === 'editor' || currentScreen === 'queue' || currentScreen === 'auto-create-editor' || currentScreen === 'faq-setup' || currentScreen === 'faq-editor' || currentScreen === 'faq-export') {
      router.push('/editor')
    }
